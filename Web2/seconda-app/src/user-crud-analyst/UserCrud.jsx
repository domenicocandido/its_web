            ...
            {users.map((u) => {
              return (
                <tr key={u.id}>
                  ...
                  <td>{u.telefono}</td>
                  <td>{u.email}</td>
                  <td><button className="btn btn-danger" onClick={()=>handleDelete(u.id)}>Elimina</button> <button className="btn btn-danger" onClick={()=>handleDelete(u.id)}>Elimina</button></td>
